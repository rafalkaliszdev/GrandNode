...
namespace Grand.Web.Framework
{
    public class PublicStoreAllowNavigationAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            string actionName = filterContext.ActionDescriptor.DisplayName;//.ActionName;
            ...
            //there are no child actions in controllers, they are now in view components
            ...
            var permissionService = EngineContextExperimental.Current.Resolve<IPermissionService>();
