...
namespace Grand.Web.Framework.Localization
{
    ...
    public class LocalizedRoute : Route
    {
        ...
        /// <param name="routeHandler">The object that processes requests for the route.</param>
        //public LocalizedRoute(string url, /*RouteValueDictionary*/object defaults, IRouteHandler routeHandler)
        ...
        /// <param name="routeHandler">The object that processes requests for the route.</param>
        //public LocalizedRoute(string url, /*RouteValueDictionary*/object defaults, /*RouteValueDictionary*/object constraints, IRouteHandler routeHandler)
        ...
        /// <param name="routeHandler">The object that processes requests for the route.</param>
        //public LocalizedRoute(string url, /*RouteValueDictionary*/object defaults, /*RouteValueDictionary*/object constraints, /*RouteValueDictionary*/object dataTokens, IRouteHandler routeHandler)
        ...
        /// </returns>
        //public override VirtualPathData GetVirtualPath(RequestContext requestContext, /*RouteValueDictionary*/object values)
        //{
