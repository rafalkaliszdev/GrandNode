...
namespace Grand.Web.Framework.Kendoui
{
    /// <summary>
    ...
    public class Filter
    {
        ...
        public string ToExpression(IList<Filter> filters)
        {
            ...
            {
                return String.Format("{0}.IndexOf(@{1}, System.StringComparison.OrdinalIgnoreCase) >= 0", Field, index);
            }
            ...
            {
                return String.Format("{0}.{1}(@{2}, System.StringComparison.OrdinalIgnoreCase)", Field, comparison, index);
            }
