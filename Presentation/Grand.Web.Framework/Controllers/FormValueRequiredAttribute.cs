...
namespace Grand.Web.Framework.Controllers
{
    ...
    public class FormValueRequiredAttribute : ActionMethodSelectorAttribute
    {
        ...
        //                        {
        //                            //"name" only
        //                            if (controllerContext.HttpContext.Request.Form.AllKeys.Any(x => x.Equals(buttonName, StringComparison.OrdinalIgnoreCase)))
        //                                return true;
        //                        }
        //                        else
        //                        {
        ...
        //                        {
        //                            //"name" only
        //                            if (controllerContext.HttpContext.Request.Form.AllKeys.Any(x => x.StartsWith(buttonName, StringComparison.OrdinalIgnoreCase)))
        //                                return true;
        //                        }
        //                        else
        //                        {
