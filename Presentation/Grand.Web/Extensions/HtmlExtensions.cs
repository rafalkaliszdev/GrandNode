...
//            var storeLocation = EngineContextExperimental.Current.Resolve<IWebHelper>().GetStoreLocation();
...
//            }
//            return HtmlString.Create(result);
//        }
...
//                return HtmlString.Create(String.Format(localizationService.GetResource("Forum.Topics.GotoPostPager"), links.ToString()));
//            }
//            return HtmlString.Create(string.Empty);
//        }
...
//            var cacheManager = EngineContextExperimental.Current.ContainerManager.Resolve<ICacheManager>();
...
//            {
//                var topicService = EngineContextExperimental.Current.Resolve<ITopicService>();
