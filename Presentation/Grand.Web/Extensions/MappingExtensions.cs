...
namespace Grand.Web.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static CategoryModel ToModel(this Category entity)
        {
            ...
            {
                Id = entity.Id,
                Name = entity.Name,//entity.GetLocalized(x => x.Name),
                Description = entity.Description,//entity.GetLocalized(x => x.Description),
                MetaKeywords = entity.MetaKeywords,//entity.GetLocalized(x => x.MetaKeywords),
                MetaDescription = entity.MetaDescription,//entity.GetLocalized(x => x.MetaDescription),
                MetaTitle = entity.MetaTitle,//entity.GetLocalized(x => x.MetaTitle),
                SeName = entity.SeName,//entity.GetSeName(),
            };
            return model;
        }
