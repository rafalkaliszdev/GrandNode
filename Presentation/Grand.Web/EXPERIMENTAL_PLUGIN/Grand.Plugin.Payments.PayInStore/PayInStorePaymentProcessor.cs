...
using Grand.Web.EXPERIMENTAL_PLUGIN.Grand.Plugin.Payments.PayInStore.Controllers;
...
namespace Grand.Web.EXPERIMENTAL_PLUGIN.Grand.Plugin.Payments.PayInStore
{
    /// <summary>
