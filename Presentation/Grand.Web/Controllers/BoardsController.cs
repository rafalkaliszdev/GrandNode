...
//        {
//            var customer = EngineContextExperimental.Current.Resolve<ICustomerService>().GetCustomerById(topic.CustomerId);
...
//        [ChildActionOnly]
//        public virtual IActionResult ActiveDiscussionsSmall()
//        {
//            if (!_forumSettings.ForumsEnabled)
//            {
//                return RedirectToRoute("HomePage");
...
//                {
//                    var customer = EngineContextExperimental.Current.Resolve<ICustomerService>().GetCustomerById(post.CustomerId);
...
//                        EngineContextExperimental.Current.Resolve<ICustomerService>().UpdateHasForumTopic(_workContext.CurrentCustomer.Id);
//                    }
//                    //forum post
...
//                    var customer = EngineContextExperimental.Current.Resolve<ICustomerService>().GetCustomerById(quotePost.CustomerId);
...
//                        EngineContextExperimental.Current.Resolve<ICustomerService>().UpdateHasForumPost(_workContext.CurrentCustomer.Id);
//                    }
...
//        [ChildActionOnly]
//        public virtual IActionResult LastPost(string forumPostId, bool showTopic)
//        {
...
//        [ChildActionOnly]
//        public virtual IActionResult ForumBreadcrumb(string forumGroupId, string forumId, string forumTopicId)
//        {
