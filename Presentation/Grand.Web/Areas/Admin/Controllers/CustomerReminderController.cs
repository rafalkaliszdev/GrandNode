...
//        public ActionResult Create(CustomerReminderModel model, bool continueEditing)
//        {
//            if (!_permissionService.Authorize(StandardPermissionProvider.ManageReminders))
//                return AccessDeniedView();
...
//        [HttpPost, ParameterBasedOnFormName("save-continue", "continueEditing")]
//        public ActionResult Edit(CustomerReminderModel model, bool continueEditing)
//        {
//            if (!_permissionService.Authorize(StandardPermissionProvider.ManageReminders))
//                return AccessDeniedView();
...
//        [HttpPost, ParameterBasedOnFormName("save-continue", "continueEditing")]
//        public ActionResult AddCondition(CustomerReminderModel.ConditionModel model, bool continueEditing)
//        {
...
//        [HttpPost]
//        public ActionResult CategoryAddPopupList(DataSourceRequest command, CustomerReminderModel.ConditionModel.AddCategoryConditionModel model)
//        {
//            if (!_permissionService.Authorize(StandardPermissionProvider.ManageReminders))
//                return AccessDeniedView();
...
//        public ActionResult CategoryAddPopup(string btnId, CustomerReminderModel.ConditionModel.AddCategoryConditionModel model)
//        {
//            if (!_permissionService.Authorize(StandardPermissionProvider.ManageReminders))
//                return AccessDeniedView();
...
//        [HttpPost]
//        public ActionResult ManufacturerAddPopupList(DataSourceRequest command, CustomerReminderModel.ConditionModel.AddManufacturerConditionModel model)
//        {
//            if (!_permissionService.Authorize(StandardPermissionProvider.ManageReminders))
//                return AccessDeniedView();
...
//        [HttpPost]
//        [FormValueRequired("save")]
//        public ActionResult ManufacturerAddPopup(string btnId, CustomerReminderModel.ConditionModel.AddManufacturerConditionModel model)
//        {
//            if (!_permissionService.Authorize(StandardPermissionProvider.ManageReminders))
//                return AccessDeniedView();
...
//        [HttpPost]
//        [FormValueRequired("save")]
//        public ActionResult ProductAddPopup(string btnId, CustomerReminderModel.ConditionModel.AddProductToConditionModel model)
//        {
//            if (!_permissionService.Authorize(StandardPermissionProvider.ManageReminders))
//                return AccessDeniedView();
...
//        [HttpPost]
//        public ActionResult ConditionCustomerTagInsert(CustomerReminderModel.ConditionModel.AddCustomerTagConditionModel model)
//        {
//            if (!_permissionService.Authorize(StandardPermissionProvider.ManageReminders))
//                return AccessDeniedView();
...
//        [HttpPost]
//        public ActionResult ConditionCustomerRoleInsert(CustomerReminderModel.ConditionModel.AddCustomerRoleConditionModel model)
//        {
//            if (!_permissionService.Authorize(StandardPermissionProvider.ManageReminders))
//                return AccessDeniedView();
...
//        [HttpPost]
//        public ActionResult ConditionCustomerRegisterInsert(CustomerReminderModel.ConditionModel.AddCustomerRegisterConditionModel model)
//        {
//            if (!_permissionService.Authorize(StandardPermissionProvider.ManageReminders))
//                return AccessDeniedView();
...
//        }
//        [HttpPost]
//        public ActionResult ConditionCustomerRegisterUpdate(CustomerReminderModel.ConditionModel.AddCustomerRegisterConditionModel model)
//        {
//            if (!_permissionService.Authorize(StandardPermissionProvider.ManageReminders))
//                return AccessDeniedView();
...
//        [HttpPost]
//        public ActionResult ConditionCustomCustomerAttributeInsert(CustomerReminderModel.ConditionModel.AddCustomCustomerAttributeConditionModel model)
//        {
//            if (!_permissionService.Authorize(StandardPermissionProvider.ManageReminders))
//                return AccessDeniedView();
...
//        }
//        [HttpPost]
//        public ActionResult ConditionCustomCustomerAttributeUpdate(CustomerReminderModel.ConditionModel.AddCustomCustomerAttributeConditionModel model)
//        {
//            if (!_permissionService.Authorize(StandardPermissionProvider.ManageReminders))
//                return AccessDeniedView();
...
//        [HttpPost, ParameterBasedOnFormName("save-continue", "continueEditing")]
//        public ActionResult AddLevel(CustomerReminderModel.ReminderLevelModel model, bool continueEditing)
//        {
//            if (!_permissionService.Authorize(StandardPermissionProvider.ManageReminders))
//                return AccessDeniedView();
//            var customerReminder = _customerReminderService.GetCustomerReminderById(model.CustomerReminderId);
