...
namespace Grand.Web.Areas.Admin.Models.Settings
{
    ...
    public partial class MediaSettingsModel : BaseNopModel
    {
        ...
        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.UseImageCompress")]
        ...
        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.WatermarkStyle ")]
        public /*FontStyle*/string WatermarkStyle { get; set; }
        public bool WatermarkStyle_OverrideForStore { get; set; }
        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.WatermarkFontColor")]
        public /*Color */string WatermarkFontColor { get; set; }
        public bool WatermarkFontColor_OverrideForStore { get; set; }
        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.WatermarkFontFamily")]
        public /*GenericFontFamilies*/string  WatermarkFontFamily { get; set; }
        public bool WatermarkFontFamily_OverrideForStore { get; set; }
        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.WatermarkPositionXPercent")]
        public int WatermarkPositionXPercent { get; set; }
        public bool WatermarkPositionXPercent_OverrideForStore { get; set; }
        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.WatermarkPositionYPercent")]
        public int WatermarkPositionYPercent { get; set; }
        public bool WatermarkPositionYPercent_OverrideForStore { get; set; }
        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.WatermarkFontSizePercent")]
        public int WatermarkFontSizePercent { get; set; }
        public bool WatermarkFontSizePercent_OverrideForStore { get; set; }
        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.WatermarkOpacityPercent")]
        public int WatermarkOpacityPercent { get; set; }
        public bool WatermarkOpacityPercent_OverrideForStore { get; set; }
        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.WatermarkDropShadow")]
        public bool WatermarkDropShadow { get; set; }
        public bool WatermarkDropShadow_OverrideForStore { get; set; }
        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.WatermarkVertical")]
        public bool WatermarkVertical { get; set; }
        public bool WatermarkVertical_OverrideForStore { get; set; }
        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.WatermarkRightToLeft")]
        ...
        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.WatermarkForPicturesAboveSize")]
        public int WatermarkForPicturesAboveSize { get; set; }
        public bool WatermarkForPicturesAboveSize_OverrideForStore { get; set; }
        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.ApplyWatermarkOnPicturesWithOriginalSize")]
        ...
        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.ApplyWatermarkForProduct")]
        public bool ApplyWatermarkForProduct { get; set; }
        public bool ApplyWatermarkForProduct_OverrideForStore { get; set; }

        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.ApplyWatermarkForCategory")]
        public bool ApplyWatermarkForCategory { get; set; }
        public bool ApplyWatermarkForCategory_OverrideForStore { get; set; }

        [GrandResourceDisplayName("Admin.Configuration.Settings.Media.ApplyWatermarkForManufacturer")]
