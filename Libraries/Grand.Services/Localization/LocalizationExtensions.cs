    ...
    public static class LocalizationExtensions
    {
            ...
            where T : ParentEntity, ILocalizedEntity
        {
            ...
            if (!String.IsNullOrEmpty(languageId))
            {
                ...
                {
                    var lService = EngineContextExperimental.Current.Resolve<ILanguageService>();
                ...
                {
                    //var leService = EngineContextExperimental.Current.Resolve<ILocalizedEntityService>();
            ...
            string resourceName)
        {
            ...
            var languageService = EngineContextExperimental.Current.Resolve<ILanguageService>();
