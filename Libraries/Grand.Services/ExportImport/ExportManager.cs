...
namespace Grand.Services.ExportImport
{
    ...
    public partial class ExportManager : IExportManager
    {
        ...
        public virtual string ExportManufacturersToXml(IList<Manufacturer> manufacturers)
        {
            ...
            //        {
            //            var product = EngineContextExperimental.Current.Resolve<IProductService>().GetProductById(productManufacturer.ProductId);
            //            if (product != null)
            //            {
        ...
        public virtual string ExportOrdersToXml(IList<Order> orders)
        {
            ...
            //    var shipments = EngineContextExperimental.Current.Resolve<IShipmentService>().GetShipmentsByOrder(order.Id);
        ...
        public virtual byte[] ExportOrdersToXlsx(IList<Order> orders)
        {
            ...
            var properties = new[]
            {
                    ...
                    new PropertyByName<Order>("BillingCountry",p=>p.BillingAddress.Return(billingAddress=>EngineContextExperimental.Current.Resolve<ICountryService>().GetCountryById(billingAddress.CountryId), null).Return(country=>country.Name,"")),
                    new PropertyByName<Order>("BillingStateProvince",p=>p.BillingAddress.Return(billingAddress=>EngineContextExperimental.Current.Resolve<IStateProvinceService>().GetStateProvinceById(billingAddress.StateProvinceId), null).Return(stateProvince=>stateProvince.Name,"")),
                    ...
                    new PropertyByName<Order>("ShippingCountry", p=>p.ShippingAddress.Return(shippingAddress=>EngineContextExperimental.Current.Resolve<ICountryService>().GetCountryById(shippingAddress.CountryId), null).Return(country=>country.Name,"")),
                    new PropertyByName<Order>("ShippingStateProvince", p=>p.ShippingAddress.Return(shippingAddress=>EngineContextExperimental.Current.Resolve<IStateProvinceService>().GetStateProvinceById(shippingAddress.StateProvinceId), null).Return(stateProvince=>stateProvince.Name,"")),
        ...
        public virtual string ExportStatesToTxt(IList<StateProvince> states)
        {
            ...
            {
                var country = EngineContextExperimental.Current.Resolve<ICountryService>().GetCountryById(state.CountryId);
