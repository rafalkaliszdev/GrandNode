            ...
            Address shippingAddress, string storeId, out bool shippingFromMultipleLocations)
        {
            ...
            foreach (var sci in cart)
            {
                ...
                else
                {
                    ...
                    if (originAddress != null)
                    {
                        var country = EngineContextExperimental.Current.Resolve<ICountryService>().GetCountryById(originAddress.CountryId);
                        var state = EngineContextExperimental.Current.Resolve<IStateProvinceService>().GetStateProvinceById(originAddress.StateProvinceId);
