...
namespace Grand.Services.Authentication.External
{
    ...
    public partial class OpenAuthenticationService : IOpenAuthenticationService
    {
        ...
        public virtual IList<IExternalAuthenticationMethod> LoadActiveExternalAuthenticationMethods(string storeId = "")
        {
            return LoadAllExternalAuthenticationMethods(storeId)
                   .Where(provider => _externalAuthenticationSettings.ActiveAuthenticationMethodSystemNames.Contains(provider.PluginDescriptor.SystemName, StringComparer.OrdinalIgnoreCase))
                   .ToList();
        }
        ...
        public virtual IList<IExternalAuthenticationMethod> LoadAllExternalAuthenticationMethods(string storeId = "")
        {
        ...
        public virtual IList<ExternalAuthenticationRecord> GetExternalIdentifiersFor(Customer customer)
        {
            ...
            var query = from p in _externalAuthenticationRecordRepository.Table
                        ...
                        select p;
            return query.ToList(); //customer.ExternalAuthenticationRecords.ToList();
        }
