...
namespace Grand.Services.Customers
{
    public static class CustomerExtensions
    {
        ...
        public static string FormatUserName(this Customer customer, bool stripTooLong = false, int maxLength = 0)
        {
            ...
            if (customer.IsGuest())
            {
                return EngineContextExperimental.Current.Resolve<ILocalizationService>().GetResource("Customer.Guest");
            }

            string result = string.Empty;
            switch (EngineContextExperimental.Current.Resolve<CustomerSettings>().CustomerNameFormat)
            {
        ...
        public static void ApplyDiscountCouponCode(this Customer customer, string couponCode)
        {
            ...
            var genericAttributeService = EngineContextExperimental.Current.Resolve<IGenericAttributeService>();
            string result = string.Empty;
            try
            {
                var existingCouponCodes = customer.GetAttribute<string>(SystemCustomerAttributeNames.DiscountCouponCode);
        ...
        public static void RemoveDiscountCouponCode(this Customer customer, string couponCode)
        {
            ...
            var customerService = EngineContextExperimental.Current.Resolve<ICustomerService>();
        ...
        public static bool PasswordIsExpired(this Customer customer)
        {
            ...
            var customerSettings = EngineContextExperimental.Current.Resolve<CustomerSettings>();
