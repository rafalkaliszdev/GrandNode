...
//        public CompareProductsService(HttpContextBase httpContextAccessor, IProductService productService,
...
//            HttpCookie compareCookie = _httpContextAccessor.Request.Cookies.Get(COMPARE_PRODUCTS_COOKIE_NAME);
...
//        {
//            var compareCookie = _httpContextAccessor.Request.Cookies.Get(COMPARE_PRODUCTS_COOKIE_NAME);
//            if (compareCookie != null)
//            {
//                compareCookie.Values.Clear();
//                compareCookie.Expires = DateTime.Now.AddYears(-1);
//                _httpContextAccessor.Response.Cookies.Set(compareCookie);
//            }
//        }
