            ...
            bool allowHyperlinks = true)
        {
                    ...
                    for (int j = 0; j < valuesStr.Count; j++)
                    {
                        ...
                        if (!attribute.ShouldHaveValues())
                        {
                            ...
                            if (attribute.AttributeControlType == AttributeControlType.MultilineTextbox)
                            {
                                ...
                                //encode (if required)
                                if (htmlEncode)
                                    attributeName = System.Net.WebUtility.HtmlEncode(attributeName);
                            ...
                            else
                            {
                                ...
                                //encode (if required)
                                if (htmlEncode)
                                    formattedAttribute = System.Net.WebUtility.HtmlEncode(formattedAttribute);
                            }
                        }
                        else
                        {
            ...
            if (renderGiftCardAttributes)
            {
                if (product.IsGiftCard)
                {
                    ...
                    if (htmlEncode)
                    {
                        giftCardFrom = System.Net.WebUtility.HtmlEncode(giftCardFrom);
                        giftCardFor = System.Net.WebUtility.HtmlEncode(giftCardFor);
                    }
