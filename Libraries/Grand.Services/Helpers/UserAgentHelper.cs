    ...
    public partial class UserAgentHelper : IUserAgentHelper
    {
        ...
        public virtual bool IsSearchEngine()
        {
            ...
            try
            {
                ...
                //tbh
                var userAgent = _httpContextAccessor.HttpContext.Request;//.UserAgent;
                return false;// bowscapXmlHelper.IsCrawler(userAgent);
            }
            catch (Exception exc)
            {
                Debug.WriteLine(exc);
        ...
        public virtual bool IsWebApi()
        {
            ...
            {
                var userAgent = _httpContextAccessor.HttpContext.Request;//.UserAgent;
                return false;// userAgent == SystemCustomerNames.WebApi;
            }
            catch (Exception exc)
            {
                Debug.WriteLine(exc);
