...
//            try
//            {
//                EnsureValidResponse(_s3Client.ListBuckets(), HttpStatusCode.OK);
//            }
//            catch (Exception ex)
//            {
...
//            var bucketExists = _s3Client.DoesS3BucketExist(_bucketName);
...
//                try
//                {
//                    EnsureValidResponse(_s3Client.PutBucket(putBucketRequest), HttpStatusCode.OK);
...
//                    throw;
//                }
//                bucketExists = _s3Client.DoesS3BucketExist(_bucketName);
//            }
//        }
...
//                Prefix = picture.Id
//            };
//            var listObjectsResponse = _s3Client.ListObjectsV2(listObjectsRequest);

//            foreach (var s3Object in listObjectsResponse.S3Objects)
//            {
//                EnsureValidResponse(_s3Client.DeleteObject(_bucketName, s3Object.Key), HttpStatusCode.NoContent);
//            }
//        }
...
//            try
//            {
//                var getObjectResponse = _s3Client.GetObject(_bucketName, thumbFileName);
...
//                };
//                EnsureValidResponse(_s3Client.PutObject(putObjectRequest), HttpStatusCode.OK);
//            }
//            _s3Client.MakeObjectPublic(_bucketName, thumbFileName, true);
//        }
