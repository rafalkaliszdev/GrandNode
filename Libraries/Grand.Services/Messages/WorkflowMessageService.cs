...
namespace Grand.Services.Messages
{
    public partial class WorkflowMessageService : IWorkflowMessageService
    {
        ...
        public virtual int SendRecurringPaymentCancelledStoreOwnerNotification(RecurringPayment recurringPayment, string languageId)
        {
            ...
            var customer = EngineContextExperimental.Current.Resolve<ICustomerService>().GetCustomerById(recurringPayment.InitialOrder.CustomerId);
            ...
            Product product, string customerEmail, string fullName, string phone, string message)
        {
            ...
            if (_commonSettings.StoreInDatabaseContactUsForm)
            {
                ...
                var contactus = new ContactUs()
                {
                    ...
                    IpAddress = EngineContextExperimental.Current.Resolve<IWebHelper>().GetCurrentIpAddress()
                };
                EngineContextExperimental.Current.Resolve<IContactUsService>().InsertContactUs(contactus);
            }
        ...
        public virtual int SendNewReturnRequestStoreOwnerNotification(ReturnRequest returnRequest, OrderItem orderItem, string languageId)
        {
            ...
            var order = EngineContextExperimental.Current.Resolve<IOrderService>().GetOrderByOrderItemId(orderItem.Id);
            var store = _storeService.GetStoreById(order.StoreId) ?? _storeContext.CurrentStore;
            languageId = EnsureLanguageIsActive(languageId, store.Id);
            ...
            //email account
            var emailAccount = GetEmailAccountOfMessageTemplate(messageTemplate, languageId);
            var customer = EngineContextExperimental.Current.Resolve<ICustomerService>().GetCustomerById(returnRequest.CustomerId);
            //tokens
            var tokens = new List<Token>();
            _messageTokenProvider.AddStoreTokens(tokens, store, emailAccount);
            _messageTokenProvider.AddCustomerTokens(tokens, customer);
            ...
            Forum forum, int friendlyForumTopicPageIndex, string languageId)
        {
            ...
            //tokens
            var tokens = new List<Token>();
            //var _forumTopic = EngineContextExperimental.Current.Resolve<IForumService>().GetTopicById(forumPost.TopicId);
        ...
        public int SendPrivateMessageNotification(PrivateMessage privateMessage, string languageId)
        {
            ...
            var tocustomer = EngineContextExperimental.Current.Resolve<ICustomerService>().GetCustomerById(privateMessage.ToCustomerId);
        ...
        public virtual int SendGiftCardNotification(GiftCard giftCard, string languageId)
        {
            ...
            var order = giftCard.PurchasedWithOrderItem != null ?
                EngineContextExperimental.Current.Resolve<IOrderService>().GetOrderByOrderItemId(giftCard.PurchasedWithOrderItem.Id) :
                null;
            if (order != null)
            ...
            string languageId)
        {
            ...
            //email account
            var emailAccount = GetEmailAccountOfMessageTemplate(messageTemplate, languageId);
            var customer = EngineContextExperimental.Current.Resolve<ICustomerService>().GetCustomerById(productReview.CustomerId);
            //tokens
            var tokens = new List<Token>();
            _messageTokenProvider.AddStoreTokens(tokens, store, emailAccount);
        ...
        public virtual int SendBlogCommentNotificationMessage(BlogComment blogComment, string languageId)
        {
            ...
            var customer = EngineContextExperimental.Current.Resolve<ICustomerService>().GetCustomerById(blogComment.CustomerId);
            _messageTokenProvider.AddCustomerTokens(tokens, customer);
        ...
        public virtual int SendNewsCommentNotificationMessage(NewsComment newsComment, string languageId)
        {
            ...
            var customer = EngineContextExperimental.Current.Resolve<ICustomerService>().GetCustomerById(newsComment.CustomerId);
            _messageTokenProvider.AddCustomerTokens(tokens, customer);
        ...
        public virtual int SendBackInStockNotification(BackInStockSubscription subscription, string languageId)
        {
            ...
            var tokens = new List<Token>();
            _messageTokenProvider.AddStoreTokens(tokens, store, emailAccount);
            var customer = EngineContextExperimental.Current.Resolve<ICustomerService>().GetCustomerById(subscription.CustomerId);
            _messageTokenProvider.AddCustomerTokens(tokens, customer);
            ...
            string senderName, string subject, string body)
        {
            ...
            //tbh
            //senderName = _httpContextAccessor.Server.HtmlEncode(senderName);
            //senderEmail = _httpContextAccessor.Server.HtmlEncode(senderEmail);
        ...
        public virtual int SendCustomerActionEvent_AddToCart_Notification(CustomerAction action, ShoppingCartItem cartItem, string languageId, Customer customer)
        {
            ...
            var tokens = new List<Token>();
            _messageTokenProvider.AddStoreTokens(tokens, store, emailAccount);
            var product = EngineContextExperimental.Current.Resolve<IProductService>().GetProductById(cartItem.ProductId);
            _messageTokenProvider.AddProductTokens(tokens, product, languageId);
