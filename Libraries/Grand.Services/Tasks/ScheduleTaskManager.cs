...
namespace Grand.Services.Tasks
{
    public class ScheduleTaskManager
    {
        ...
        public IScheduleTask ChangeTypeToRightOne(ScheduleTask scheduleTask)
        {
            ...
            //{
            //    object instance;
            //    if (!EngineContextExperimental.Current.ContainerManager.TryResolve(type2, scope, out instance))
            //    {
            //        //the type of object instance is determined by basing on "type2" variable
            //        instance = EngineContextExperimental.Current.ContainerManager.ResolveUnregistered(type2, scope);
