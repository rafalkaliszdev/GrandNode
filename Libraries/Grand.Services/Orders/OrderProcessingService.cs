    ...
    public partial class OrderProcessingService : IOrderProcessingService
    {
        ...
        protected virtual PlaceOrderContainter PreparePlaceOrderDetails(ProcessPaymentRequest processPaymentRequest)
        {
            ...
            if (!processPaymentRequest.IsRecurringPayment)
            {
                ...
                {
                    var country = EngineContextExperimental.Current.Resolve<ICountryService>().GetCountryById(details.BillingAddress.CountryId);
                    if (country != null)
            ...
            if (shoppingCartRequiresShipping)
            {
                if (!processPaymentRequest.IsRecurringPayment)
                {
                    ...
                    else
                    {
                        ...
                        {
                            var country = EngineContextExperimental.Current.Resolve<ICountryService>().GetCountryById(details.ShippingAddress.CountryId);
                            if (country != null)
