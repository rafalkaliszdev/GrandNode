...
namespace Grand.Core.Infrastructure
{
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        private void AddAssembliesInAppDomain(List<string> addedAssemblyNames, List<Assembly> assemblies)
        {
            ...
            //tbh
            foreach (/*Assembly*/var assembly in DependencyContext.Default.RuntimeLibraries)// AppDomain.CurrentDomain.GetAssemblies())
            {
                if (Matches(assembly.Name/*FullName*/))
                {
                    if (!addedAssemblyNames.Contains(assembly.Name/*FullName*/))
                    {
                        assemblies.Add(Assembly.Load(new AssemblyName(assembly.Name)));
                        addedAssemblyNames.Add(assembly.Name);
                    }
                }
            }
        }
        ...
        public virtual bool Matches(string assemblyFullName)
        {
            ...
            var migrationCustomNames = "^imagesharp|^runtime|^Libuv|^NETStandard.Library";
            if (Matches(assemblyFullName, migrationCustomNames) == true)
                return false;
