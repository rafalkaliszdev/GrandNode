...
namespace Grand.Core
{
    ...
    public partial class WebHelper : IWebHelper
    {
        ...
        public WebHelper(/*IHttpContextAccessor*/IHttpContextAccessor httpContextAccessor)
        {
        ...
        protected virtual Boolean IsRequestAvailable(IHttpContextAccessor httpContextAccessor)
        {
        ...
        public virtual string GetUrlReferrer()
        {
            ...
            //tbh seriously ll this pile of 


            //URL referrer is null in some case (for example, in IE 8)
            //if (IsRequestAvailable(_httpContextAccessor) && _httpContextAccessor.HttpContext.Request.UrlReferrer != null)
            //    referrerUrl = _httpContextAccessor.HttpContext.Request.UrlReferrer.PathAndQuery;
        ...
        {
            if (!IsRequestAvailable(_httpContextAccessor))
                return string.Empty;
            ...
            try
            {
                if (_httpContextAccessor.HttpContext.Request.Headers != null)
                {
                    ...
                    string xff = _httpContextAccessor.HttpContext.Request.Headers.Keys/*AllKeys*/
                        .Where(x => forwardedHttpHeader.Equals(x, StringComparison.OrdinalIgnoreCase))
                        .Select(k => _httpContextAccessor.HttpContext.Request.Headers[k])
                        .FirstOrDefault();
                ...
                //tbh 
                //if (String.IsNullOrEmpty(result) && _httpContextAccessor.HttpContext.RequestUserHostAddress != null)
                //{
                //    result = _httpContextAccessor.HttpContext.Request.UserHostAddress;
                //}
            }
            catch
            {
        ...
        public virtual string GetThisPageUrl(bool includeQueryString, bool useSsl)
        {
            ...
            //tbh
            //url += includeQueryString ? _httpContextAccessor.HttpContext.Request.RawUrl : _httpContextAccessor.Request.Path;
        ...
        public virtual bool IsCurrentConnectionSecured()
        {
            ...
            if (IsRequestAvailable(_httpContextAccessor))
            {
                ...
                //else
                {
                    ...
                    {
                        //tbh
                        useSsl = _httpContextAccessor.HttpContext.Request.IsHttps;// IsSecureConnection;
                    }
                    catch
                    { }
                }
        ...
        public virtual string ServerVariables(string name)
        {
            ...
            try
            {
                ...
                //if (_httpContextAccessor.HttpContext.Request.ServerVariables[name] != null)
                //{
                //    result = _httpContextAccessor.Request.ServerVariables[name];
                //}
            }
            catch
            {
        ...
        public virtual string GetStoreHost(bool useSsl)
        {
            ...
            if (DataSettingsHelper.DatabaseIsInstalled())
            {
                ...
                var storeContext = EngineContextExperimental.Current.Resolve<IStoreContext>();
        ...
        public virtual string GetStoreLocation(bool useSsl)
        {
            ...
            if (IsRequestAvailable(_httpContextAccessor))
                result = result + _httpContextAccessor.HttpContext.Request.PathBase;// ApplicationPath; //tbh
            if (!result.EndsWith("/"))
                result += "/";
        ...
        public virtual bool IsStaticResource(HttpRequest request)
        {
            ...
            //tbh nah ll it
            string extension = "qqqqq analna";// VirtualPathUtility.GetExtension(path);
        ...
        public virtual T QueryString<T>(string name)
        {
            ...
            //tbh nanaanana
            //if (IsRequestAvailable(_httpContextAccessor) && _httpContextAccessor.HttpContext.Request.QueryString[name] != null)
            //    queryParam = _httpContextAccessor.HttpContext.Request.QueryString[name];
        ...
        public virtual void RestartAppDomain(bool makeRedirect = false, string redirectUrl = "")
        {
            ...
            if (false)//CommonHelper.GetTrustLevel() > AspNetHostingPermissionLevel.Medium)
            {
                //full trust
            ...
            if (_httpContextAccessor != null && makeRedirect)
            {
        ...
        public virtual bool IsRequestBeingRedirected
        {
            get
            {
                ...
                //tbh fdsfw mac
                return false;// response.HttpContext.Request.//IsRequestBeingRedirected;
            }
        }
