        ...
        private static string Highlight(HighlightOptions options, string text)
        {
            switch (options.Language)
            {
                case "c#":
                    ...
                    return System.Net.WebUtility.HtmlDecode(csf.FormatCode(text));
                ...
                case "js":
                    ...
                    return System.Net.WebUtility.HtmlDecode(jsf.FormatCode(text));
                ...
                case "html":
                    ...
                    string code = htmlf.FormatCode(System.Net.WebUtility.HtmlDecode(text)).Trim();
                    return code.Replace("\r\n", "<br />").Replace("\n", "<br />");
                ...
                case "xml":
                    ...
                    text = StripHtml(text).Trim();
                    string xml = xmlf.FormatCode(System.Net.WebUtility.HtmlDecode(text)).Trim();
                    return xml.Replace("\r\n", "<br />").Replace("\n", "<br />");                
                ...
                case "msh":
                    ...
                    return System.Net.WebUtility.HtmlDecode(mshf.FormatCode(text));
